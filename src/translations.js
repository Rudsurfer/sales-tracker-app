...
export const translations = {
    en: {
        ...
        enterPin: 'Enter Your PIN (Position ID)',
        clockIn: 'Clock In',
        clockOut: 'Clock Out',
        ...
        finalizeWeek: 'Finalize & Lock Week',
        weekLocked: 'Week Locked',
        confirmLockWeek: 'Are you sure you want to finalize and lock this week? Actual hours will no longer be editable from this screen.',
    },
    fr: {
        ...
        timeClock: 'Horloge',
        enterPin: 'Entrez votre NIP (ID de Position)',
        clockIn: 'Pointer l\'Entrée',
        clockOut: 'Pointer la Sortie',
        clockInSuccess: 'Entrée pointée avec succès!',
        clockOutSuccess: 'Sortie pointée avec succès!',
        invalidPin: 'NIP invalide. Veuillez réessayer.',
        alreadyClockedIn: 'Vous êtes déjà pointé à l\'entrée.',
        notClockedIn: 'Vous n\'êtes pas pointé à l\'entrée.',
        finalizeWeek: 'Finaliser et Verrouiller la Semaine',
        weekLocked: 'Semaine Verrouillée',
        confirmLockWeek: 'Êtes-vous sûr de vouloir finaliser et verrouiller cette semaine? Les heures réelles ne seront plus modifiables à partir de cet écran.',
    }
};