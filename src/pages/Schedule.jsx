        ...
        <>
            ...
            <div id="printable-schedule">
                <div className="bg-gray-800 p-6 rounded-lg shadow-lg">
                    ...
                    <div className="flex justify-end mb-4 gap-4 no-print">{/* ... your original buttons ... */}</div>
                    <div className="overflow-x-auto">
                        ...
                        <table className="w-full text-sm text-left text-gray-400">
                            <thead>{/* ... your original thead ... */}</thead>
                            <tbody>{/* ... your original tbody ... */}</tbody>
                        ...
                        <div className="mt-4 flex gap-4 no-print">{/* ... your original add buttons ... */}</div>
                    </div>
                </div>
            </div>
