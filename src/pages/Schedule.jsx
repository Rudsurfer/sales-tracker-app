...
// Rudsak logo in Base64 format to embed directly into the PDF.
...
export const Schedule = ({ t, selectedStore, currentWeek, currentYear, API_BASE_URL, allEmployees }) => {
    ...
    const fetchSchedule = async () => {
        ...
        url.searchParams.append('week', currentWeek);
        url.searchParams.append('year', currentYear);
    
        try {
            // Use the newly constructed URL
    ...
    const handleDownloadPdf = async () => {
        ...
        // Add Summary Footer on the last page
