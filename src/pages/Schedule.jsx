...
// --- START: This is the only change in this file ---
const printStyles = `
    @media print {
        body * {
            visibility: hidden;
...
`;
// --- END: This is the only change in this file ---
...
export const Schedule = ({ allEmployees, selectedStore, currentWeek, currentYear, API_BASE_URL, setNotification, t, language }) => {
    ...
    return (
        <>
            ...
            <div className="space-y-6 printable-schedule">
                    ...
                    <table className="w-full text-sm text-left text-gray-400">
                        ...
                        <tbody>
                            {schedule.rows?.map(row => {
                                const { totalScheduled } = Object.values(row.shifts || {}).reduce(
                                    (acc, shift) => {
